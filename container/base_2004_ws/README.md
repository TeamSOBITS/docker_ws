...
`base_2004_ws`コンテナは以下の環境で構築されます．
- Ubuntu : 20.04 (Focal Fossa)
<!-- - ROS : None -->
- OpenCV : 4.10.0(2024-10-04) or 4.8.0 (2023-08-04) or 4.6.0 (2021-12-30)
- Python : 3.8 (デフォルト)
...
また，コンテナ内の `catkin_ws/src` は， `base_2004_ws/src` と接続されています．(run.shを参照) 
...
1. コンテナのフォルダをコピします．
```bash
$ cp -r {docker_wsのPATH}/container/base_2004_ws/ {コンテナPATH}
# 例: $ cp -r ~/docker_ws/container/base_2004_ws/ ~/
```
> **Warning**
> コピされたフォルダの名前を変えてください．
> 例: `base_2004_ws` → `my_new_ws`
